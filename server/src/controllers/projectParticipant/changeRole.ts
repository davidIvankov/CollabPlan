import { changeRoleSchema } from '@server/entities/projectParticipant'
...
export default authenticatedProcedure
  ...
  .mutation(async ({ input, ctx: { authUser, repos } }) => {
    ...
    checkOwnership(project, authUser, 'set roles in')

    return repos.projectParticipantRepository.changeRole(input)
  })
